...
Micro: precision 1.00, recall 0.94. Macro over papers: precision 1.00, recall 0.90.

Datasets scored:

- `08562126a9b9aab8`: `/home/yangrm/Projects/paperfacts/data/docs/08562126a9b9aab8/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `1048c42316a5c9f8`: `/home/yangrm/Projects/paperfacts/data/docs/1048c42316a5c9f8/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `219df6e1cd7b19fe`: `/home/yangrm/Projects/paperfacts/data/docs/219df6e1cd7b19fe/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `534040e6151e0636`: `/home/yangrm/Projects/paperfacts/data/docs/534040e6151e0636/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `5c10f7a0128f15e0`: `/home/yangrm/Projects/paperfacts/data/docs/5c10f7a0128f15e0/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `80c3b69d570c2b6d`: `/home/yangrm/Projects/paperfacts/data/docs/80c3b69d570c2b6d/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `8977655673fa6d9a`: `/home/yangrm/Projects/paperfacts/data/docs/8977655673fa6d9a/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `c3ab31d08acc066b`: `/home/yangrm/Projects/paperfacts/data/docs/c3ab31d08acc066b/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `e6939c89e983c426`: `/home/yangrm/Projects/paperfacts/data/docs/e6939c89e983c426/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `e855631c6f46a0ee`: `/home/yangrm/Projects/paperfacts/data/docs/e855631c6f46a0ee/datasets/d3f0e6244743.08d8bcfc3a46.json`
- `ffd70c234c43ba93`: `/home/yangrm/Projects/paperfacts/data/docs/ffd70c234c43ba93/datasets/d3f0e6244743.08d8bcfc3a46.json`

## Overall

| all | correct | soft | wrong | missing | extra | disputed | precision | recall |
|---|---|---|---|---|---|---|---|---|
| all | 661 | 46 | 0 | 41 | 1 | 0 | 1.00 | 0.94 |

## Per field group

| group | correct | soft | wrong | missing | extra | disputed | precision | recall |
|---|---|---|---|---|---|---|---|---|
| film | 155 | 14 | 0 | 10 | 1 | 0 | 0.99 | 0.94 |
| process | 501 | 32 | 0 | 29 | 0 | 0 | 1.00 | 0.95 |
...
| transmittance | 63 | 2 | 0 | 1 | 0 | 0 | 1.00 | 0.98 |
...
| 534040e6151e0636 | target | target | component | missing | None | 3 wt.% Ga2O3 + 97 wt.% ZnO (p1) | conflict \| 双路比较存在冲突或歧义，需人工复核; mineru: 3 wt.% ; mineru: 97 wt.% ; paddleocr_vl: 3 wt.% gallium oxide (purity 99.95%) and 97 wt.% zinc oxide (purity 99.95%) wt.% \| mineru_p1_b3; paddleocr_vl_p1_b3 |
