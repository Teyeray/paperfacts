...
| 534040e6151e0636 | target | target | component | missing | None | 3 wt.% Ga2O3 + 97 wt.% ZnO (p1) | conflict \| 双路比较存在冲突或歧义，需人工复核; mineru: 3 wt.% wt.%; mineru: 97 wt.% wt.%; paddleocr_vl: 3 wt.% gallium oxide (purity 99.95%) and 97 wt.% zinc oxide (purity 99.95%) wt.% \| mineru_p1_b3; paddleocr_vl_p1_b3 |
