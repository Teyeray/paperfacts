...
# The origin a caller that hands no profile gets -- the pinned prompt snapshot, `paperfacts prompts --field` --
# is the wording every stored TCO extraction was asked with. Extraction always passes its profile's own
